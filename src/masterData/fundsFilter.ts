...
export const FundEquitySubCategorySchema      = z.nativeEnum(FundEquitySubCategoryEnum);
export const FundDebtSubCategorySchema        = z.nativeEnum(FundDebtSubCategoryEnum);
export const FundHybridSubCategorySchema      = z.nativeEnum(FundHybridSubCategoryEnum);
export const FundCommoditiesSubCategorySchema = z.nativeEnum(FundCommoditiesSubCategoryEnum);
...
export type FundSortBy                  = z.infer<typeof FundSortBySchema>;
...
export type FundCommoditiesSubCategory  = z.infer<typeof FundCommoditiesSubCategorySchema>;
...
/** Generic type for a single filter group with a UI label and its options array */
export type FundFilterGroup<T>          = { label: string; options: T[] };
...
export const fundSortByOptions: readonly FundSortByItem[] = Object.freeze([
  ...
  { value: FundSortByEnum.RISK_LOW_TO_HIGH,    label: 'Risk: Low to High',    isActive: true },
...
export const fundCategoryOptions: readonly FundCategoryItem[] = Object.freeze([
  {
    ...
    isActive: true,
    subCategories: [
      { value: FundEquitySubCategoryEnum.FLEXI_CAP,        label: 'Flexi Cap',        isActive: true },
      { value: FundEquitySubCategoryEnum.INTERNATIONAL,    label: 'International',    isActive: true },
      { value: FundEquitySubCategoryEnum.LARGE_AND_MIDCAP, label: 'Large & MidCap',   isActive: true },
      { value: FundEquitySubCategoryEnum.LARGE_CAP,        label: 'Large Cap',        isActive: true },
      { value: FundEquitySubCategoryEnum.MID_CAP,          label: 'Mid Cap',          isActive: true },
      { value: FundEquitySubCategoryEnum.MULTI_CAP,        label: 'Multi Cap',        isActive: true },
      { value: FundEquitySubCategoryEnum.SECTORAL,         label: 'Sectoral',         isActive: true },
      { value: FundEquitySubCategoryEnum.SMALL_CAP,        label: 'Small Cap',        isActive: true },
      { value: FundEquitySubCategoryEnum.ELSS,             label: 'ELSS',             isActive: true },
      { value: FundEquitySubCategoryEnum.THEMATIC,         label: 'Thematic',         isActive: true },
      { value: FundEquitySubCategoryEnum.VALUE_ORIENTED,   label: 'Value Oriented',   isActive: true },
    ],
  },
  {
    ...
    isActive: true,
    subCategories: [
      { value: FundDebtSubCategoryEnum.BANKING_AND_PSU,         label: 'Banking and PSU',                  isActive: true },
      { value: FundDebtSubCategoryEnum.CORPORATE_BOND,          label: 'Corporate Bond',                   isActive: true },
      { value: FundDebtSubCategoryEnum.CREDIT_RISK,             label: 'Credit Risk',                      isActive: true },
      { value: FundDebtSubCategoryEnum.DYNAMIC_BOND,            label: 'Dynamic Bond',                     isActive: true },
      { value: FundDebtSubCategoryEnum.FIXED_MATURITY,          label: 'Fixed Maturity',                   isActive: true },
      { value: FundDebtSubCategoryEnum.FLOATER,                 label: 'Floater',                          isActive: true },
      { value: FundDebtSubCategoryEnum.GILT,                    label: 'Gilt',                             isActive: true },
      { value: FundDebtSubCategoryEnum.GILT_10_YEAR_CONSTANT,   label: 'Gilt with 10 year Constant Duration', isActive: true },
      { value: FundDebtSubCategoryEnum.LIQUID,                  label: 'Liquid',                           isActive: true },
      { value: FundDebtSubCategoryEnum.LONG_DURATION,           label: 'Long Duration',                    isActive: true },
      { value: FundDebtSubCategoryEnum.LOW_DURATION,            label: 'Low Duration',                     isActive: true },
      { value: FundDebtSubCategoryEnum.MEDIUM_DURATION,         label: 'Medium Duration',                  isActive: true },
      { value: FundDebtSubCategoryEnum.MEDIUM_TO_LONG_DURATION, label: 'Medium to Long Duration',           isActive: true },
      { value: FundDebtSubCategoryEnum.MONEY_MARKET,            label: 'Money Market',                     isActive: true },
      { value: FundDebtSubCategoryEnum.OVERNIGHT,               label: 'Overnight',                        isActive: true },
      { value: FundDebtSubCategoryEnum.SHORT_DURATION,          label: 'Short Duration',                   isActive: true },
      { value: FundDebtSubCategoryEnum.TARGET_MATURITY,         label: 'Target Maturity',                  isActive: true },
      { value: FundDebtSubCategoryEnum.ULTRA_SHORT_DURATION,    label: 'Ultra Short Duration',             isActive: true },
    ],
  },
  {
    ...
    isActive: true,
    subCategories: [
      { value: FundHybridSubCategoryEnum.AGGRESSIVE_HYBRID,        label: 'Aggressive Hybrid',        isActive: true },
      { value: FundHybridSubCategoryEnum.ARBITRAGE,                label: 'Arbitrage',                isActive: true },
      { value: FundHybridSubCategoryEnum.BALANCED_HYBRID,          label: 'Balanced Hybrid',          isActive: true },
      { value: FundHybridSubCategoryEnum.CONSERVATIVE_HYBRID,      label: 'Conservative Hybrid',      isActive: true },
      { value: FundHybridSubCategoryEnum.DYNAMIC_ASSET_ALLOCATION, label: 'Dynamic Asset Allocation', isActive: true },
      { value: FundHybridSubCategoryEnum.EQUITY_SAVINGS,           label: 'Equity Savings',           isActive: true },
      { value: FundHybridSubCategoryEnum.MULTI_ASSET_ALLOCATION,   label: 'Multi Asset Allocation',   isActive: true },
    ],
  },
  {
    ...
    isActive: true,
    subCategories: [
      { value: FundCommoditiesSubCategoryEnum.GOLD,   label: 'Gold',   isActive: true },
      { value: FundCommoditiesSubCategoryEnum.SILVER, label: 'Silver', isActive: true },
    ],
  },
]);
...
export const fundRiskOptions: readonly FundRiskItem[] = Object.freeze([
  ...
  { value: FundRiskEnum.MODERATELY_LOW,  label: 'Moderately Low',  isActive: true },
  { value: FundRiskEnum.MODERATE,        label: 'Moderate',        isActive: true },
  { value: FundRiskEnum.MODERATELY_HIGH, label: 'Moderately High', isActive: true },
