...
export enum MutualFundInvestmentType {
  SIP = 'SIP',
  LUMPSUM = 'LUMPSUM',
}

/** SIP or Order record returned by getMutualFundsInvestment (API status success). */
...
export type MutualFundsInvestmentItem = z.infer<
  typeof MutualFundsInvestmentItemSchema
>;
...
export type MutualFundsInvestmentList = z.infer<
  typeof MutualFundsInvestmentListSchema
>;
